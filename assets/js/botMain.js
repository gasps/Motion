...
const { connectBot, delay, salt, addPlayer, checkVer, checkTMCVer, rmPlayer, errBot, botApi, sendLog, exeAll, startScript, mineflayer, loadTheme, createPopup, formatText } = require( __dirname + '/assets/js/cf.js')
const antiafk = require( __dirname +  '/assets/plugins/antiafk')
process.NODE_TLS_REJECT_UNAUTHORIZED = "0"
let currentTime = Date.now()

//ids
let idVersion = document.getElementById('downbarVersion')
let idTrafficerVer = document.getElementById('tmcversion')
